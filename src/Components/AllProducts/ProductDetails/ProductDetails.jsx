        ...
        <div>
          ...
          <div className="flex gap-5">
            <button
              ...
              className="text-gray-200 font-semibold px-4 py-2 bg-gradient-to-r from-red-500 to-red-800 rounded-md w-full text-center flex items-center gap-3"
            >
              Add To Cart <MdAddShoppingCart></MdAddShoppingCart>
            </button>
            <Link
              onClick={() => handleAddToWishlist(_id)}
              className="text-gray-500 font-semibold px-4 py-2 bg-[#F6F7F7] border border-[#d3d3d4] hover:bg-gradient-to-r from-red-500 to-red-800 hover:text-white transition duration-300 rounded-md w-full text-center flex items-center gap-3"
            >
              Add To Wishlist <IoHeartSharp></IoHeartSharp>
            </Link>
          </div>
        </div>
      </div>
