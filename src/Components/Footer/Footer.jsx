...
const Footer = () => {
  return (
    <div className="relative">
      <img src="../../../public/bg.jpg" className="absolute inset-0 w-full h-full object-cover" alt="" />
      <div className="absolute inset-0 bg-gradient-to-r from-blue-900 via-blue-950 to-blue-950 opacity-50 border-t-2 border-blue-400"></div>
      <div className="relative z-10">
      <footer className="footer p-10 text-base-content">
        <aside>
          <img className="w-28" src="/src/assets/images/logo.png" alt="" />
          <p className="text-white font-semibold">
            <span className="bg-gradient-to-r from-red-500 to-red-800 bg-clip-text text-transparent font-bold text-4xl ">Beyond Bazar</span>
            <br />
            Find what you need.
          </p>
        </aside>
